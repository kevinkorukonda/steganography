...
function encodePixel(coverPixel, secretPixel) {
    ...
    /// if its greater than the color threshold 
...
function decodePixel(coverPixel) {
    var curRed = coverPixel[RED];
    var curGreen = coverPixel[GREEN];
    var curBlue = coverPixel[BLUE];
    
    var secretPixel = [0, 0, 0];
    var redBit = getLowestBit(curRed);
    var greenBit = getLowestBit(curGreen);
    var blueBit = getLowestBit(curBlue);
